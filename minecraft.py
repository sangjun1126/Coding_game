...
# 여기서 코드를 작성하고 필요한 사진들을 검색해 다운로드 해준다.
...
class Voxel(Button):  # Changed from 'button' to 'Button'
    def __init__(self, position=(0, 0, 0), texture='assets/grass.png'):  # Added default values
        super().__init__(
            parent=scene,
            position=position,
            model='assets/block',
